...
@section('content')
    ...
    <div class="row tm-row tm-mb-120">
        <div class="col-12">
            <h3 class="tm-color-primary tm-post-title tm-mb-60 font-weight-bold">Contact Us</h3>
        </div>
        <div class="col-lg-7 tm-contact-left">
            <form method="POST" action="/contact/submit" class="mb-5 ml-auto mr-0 tm-contact-form">
                @csrf
                <div class="form-group row mb-4">
                    <label for="name"
                           class="col-sm-3 col-form-label text-right tm-color-primary font-weight-bold">Name</label>
                    <div class="col-sm-9">
                        <input class="form-control mr-0 ml-auto" name="name" id="name" type="text" required>
                    </div>
                </div>
                <div class="form-group row mb-4">
                    <label for="email" class="col-sm-3 col-form-label text-right tm-color-primary font-weight-bold">Email</label>
                    <div class="col-sm-9">
                        <input class="form-control mr-0 ml-auto" name="email" id="email" type="email" required>
                    </div>
                </div>
                <div class="form-group row mb-4">
                    <label for="subject" class="col-sm-3 col-form-label text-right tm-color-primary font-weight-bold">Subject</label>
                    <div class="col-sm-9">
                        <input class="form-control mr-0 ml-auto" name="subject" id="subject" type="text" required>
                    </div>
                </div>
                <div class="form-group row mb-5">
                    <label for="message" class="col-sm-3 col-form-label text-right tm-color-primary font-weight-bold">Message</label>
                    <div class="col-sm-9">
